...
public class VersionTest {
    ...
    public void testSort() {
        ...
        for (int i = 0; i < versions.size(); i++) {
            assertEquals("sorted version is not the same as unsorted (sorted: " + versionsSorted + ", versions: " + versions + ")", versions.get(i), versionsSorted.get(i));
        }
    }
    ...
    private void checkVersion(Version v, String major, String minor, String bugfix, String hotfix) {
        checkVersion(v, major, minor, bugfix, hotfix, null);
    }

    private void checkVersion(Version v, String major, String minor, String bugfix, String hotfix, String qualifier) {
